...
const Consent = () => {
    return (
        <div className='consent'>
            ...
            <ol className='body'>
                <li>I am aware that the collection, processing and use of my data is voluntary. The study can be cancelled by me at any time without mentioning reasons and without causing meany disadvantages. In the event of cancellation, all data recorded of me will beirrevocably deleted.</li>
                <li>I agree that my following data are processed:
                    ...
                    Your data will be needed to answer scientific research questions regarding technologyuse in virtual worlds and real-world public settings. The study is not intended to evaluateyou or your performance, but to help in designing usable valuable experiences.
                </li>
                <li>
                I have been informed that the code I have selected will only be used to merge the datafrom the different parts of the study. My name is neither associated with the collecteddata nor with the study code.
                </li>
                <li>
                ...
                <li>I have been informed that my personal data collected in the context of the abovepurposes will be processed in compliance with the General Data Protection Regulation(GDPR and BayDSG).</li>
                <li>Furthermore, I have been informed that I can amend the given consent without statingany reasons with effect for the future or revoke it completely. I can send my declaration of cancellation by stating the study title "Remote Eye-Tracking Studies: challenges and opportunities of conducting eye-tracking studies out of the lab" and my study code by post or e-mail to
                    ...
                    <p>I have understood that my data will be completely anonymized after this deadline and thus cannot be deleted.</p>
                </li>
                <li>
            ...
            <button className='button'>I understand</button>
        </div>
    )
}
